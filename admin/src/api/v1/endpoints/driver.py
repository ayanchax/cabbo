...
from customer_api.src.core.security import ActiveInactiveStatusEnum, RoleEnum, validate_user_token
from customer_api.src.db.database import a_yield_mysql_session, yield_mysql_session
from customer_api.src.models.common import S3ObjectInfo
from customer_api.src.models.documents.kyc_document_enum import KYCDocumentTypeEnum
...
from customer_api.src.models.trip.trip_enums import TripStatusEnum
from customer_api.src.models.trip.trip_schema import AdditionalDetailsOnTripStatusChange
from customer_api.src.models.user.user_orm import User
from sqlalchemy.orm import Session
from customer_api.src.services.kyc_service import (
    list_kyc_documents,
...
from customer_api.src.services.file_service import (
    remove_driver_profile_picture,
    save_driver_profile_picture,
)
from customer_api.src.services.notification_service import notify_driver_onboarded
from customer_api.src.services.orchestration_service import BackgroundTaskOrchestrator
from customer_api.src.services.validation_service import validate_driver_payload
