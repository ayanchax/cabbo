...
def upgrade() -> None:
    ...
    sa.Column('refund_status', sa.Enum('processed', 'pending', 'completed', 'failed', 'unknown', name='refundstatus'), nullable=True, comment='Status of the refund transaction from the payment provider, e.g., pending, completed, failed, etc.'),
