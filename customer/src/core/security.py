...
from customer_api.src.core.constants import APP_NAME, Environment
...
def validate_customer_token(
    ...
    try:
        ...
        from customer_api.src.services.customer_service import get_active_customer_by_id_and_bearer_token
...
def validate_user_token(
    ...
    try:
        ...
        if not user_id:
            raise CabboException("Invalid token: missing subject.", status_code=401, error_code=INVALID_TOKEN)
        from customer_api.src.services.user_service import get_active_user_by_id_and_bearer_token
