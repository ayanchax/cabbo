...
from customer_api.src.core.trip_helpers import get_all_trip_types, get_trip_package_configuration_list_by_region_code, get_trip_type_id_by_trip_type
from customer_api.src.models.airport.airport_schema import AirportSchema
from customer_api.src.models.cab.cab_schema import CabTypeSchema, FuelTypeSchema
from customer_api.src.models.geography.geography_schema import Geographies
...
from customer_api.src.models.trip.trip_schema import TripTypeSchema
from customer_api.src.services.cab_service import get_all_cabs
from customer_api.src.services.fuel_service import get_all_fuel_types
...
class ConfigStore(BaseModel):
    ...
    def _retrieve_and_set_airport_locations(self, db: Session):
        ...
        from customer_api.src.services.airport_service import get_all_airports
