from customer_api.src.models.customer.recent_location_orm import CustomerRecentLocation
from customer_api.src.models.customer.recent_location_schema import RecentLocationRead
