...
from customer_api.src.core.trip_constants import DEFAULT_PRIOR_BOOKING_WINDOW_HOURS, OUTSTATION_DEFAULTS
from customer_api.src.core.trip_helpers import get_prior_booking_window_hours
from customer_api.src.db.database import get_mysql_local_session
from customer_api.src.models.airport.airport_schema import AirportSchema
from customer_api.src.models.customer.customer_schema import (
    CustomerCreate,
...
from customer_api.src.models.customer.passenger_schema import PassengerCreate, PassengerUpdate
from customer_api.src.models.driver.driver_schema import DriverCreateSchema, DriverUpdateSchema
...
from customer_api.src.models.trip.trip_enums import TripStatusEnum, TripTypeEnum
from customer_api.src.models.trip.trip_orm import Trip, TripTypeMaster
from customer_api.src.models.trip.trip_schema import (
    TripBookRequest,
    TripClassificationRequest,
    TripSearchRequest,
)
from customer_api.src.models.user.user_schema import UserCreateSchema, UserUpdateSchema
from customer_api.src.services.airport_service import (
...
from customer_api.src.services.location_service import get_distance_km, get_distance_km_haversine
from customer_api.src.utils.utility import (
...
def validate_serviceable_area(
    ...
    # For outstation trips, both pickup and drop must be in serviceable states
        ...
        from customer_api.src.services.trips.outstation_service import get_allowed_outstation_states
