...
from customer_api.src.models.trip.trip_orm import TripStatusAudit
from customer_api.src.models.trip.trip_enums import TripStatusEnum, CancellationSubStatusEnum
