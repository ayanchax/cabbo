...
from customer_api.src.models.cab.cab_orm import CabType
from customer_api.src.models.cab.cab_schema import CabTypeSchema, CabTypeUpdateSchema
import logging

from customer_api.src.models.common import LuggageInfoSchema
from customer_api.src.models.trip.trip_enums import CarTypeEnum
from customer_api.src.models.trip.trip_orm import Trip
from customer_api.src.models.trip.trip_schema import TripSearchRequest
...
def serialize_fleet(trip: Trip,  trip_dict: dict, db: Session=None):
    ...
    from customer_api.src.services.configuration_service import get_all_cabs as get_all_cabs_config
