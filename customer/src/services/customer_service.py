...
from customer_api.src.core.exceptions import CabboException, USER_NOT_FOUND, GENERIC_EXCEPTION
from datetime import datetime, timezone
from customer_api.src.core.security import (
    generate_jwt_token,
    decode_jwt_token,
...
from customer_api.src.services.customer_email_verification_service import get_existing_email_verification_link
