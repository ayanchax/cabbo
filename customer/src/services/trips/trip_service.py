...
from customer_api.src.core.exceptions import CabboException, GENERIC_EXCEPTION
from customer_api.src.core.security import RoleEnum, verify_hash
from customer_api.src.core.store import ConfigStore
from customer_api.src.core.trip_constants import TRIP_MESSAGES, TRIP_RESPONSE_OPTIONS
from customer_api.src.core.trip_helpers import (
    attach_relationships_to_trip,
    generate_trip_field_dictionary,
    get_trip_type_id_by_trip_type,
)
from customer_api.src.models.common import AppBackgroundTask
from customer_api.src.models.customer.customer_orm import Customer
from customer_api.src.models.pricing.pricing_schema import (
    TripPackageConfigSchema,
)
from customer_api.src.models.trip.temp_trip_orm import TempTrip
...
from customer_api.src.models.trip.trip_orm import Trip, TripPackageConfig, TripTypeMaster
from customer_api.src.models.trip.trip_schema import (
...
from customer_api.src.services.cab_service import (
    get_recommended_car_type,
    remove_extra_fields_from_fleet,
    serialize_fleet,
)
from customer_api.src.services.cancelation_service import serialize_cancelation
from customer_api.src.services.configuration_service import (
    remove_extra_fields_from_currency,
    serialize_currency,
)
from customer_api.src.services.customer_service import serialize_customer
from customer_api.src.services.dispute_service import serialize_dispute
from customer_api.src.services.driver_service import remove_extra_fields_from_driver
from customer_api.src.services.location_service import remove_extra_fields_from_location
from customer_api.src.services.passenger_service import (
    get_passenger_id_from_preferences,
    populate_passenger_details,
    serialize_passenger,
    validate_passenger_id,
)
from customer_api.src.services.policy_service import serialize_cancellation_and_refund_policy
from customer_api.src.services.pricing_service import (
    get_driver_allowance,
    get_parking,
    get_tolls,
)
from customer_api.src.services.trip_package_service import (
    remove_extra_fields_from_trip_package,
    serialize_trip_package,
)
from customer_api.src.services.trip_type_service import (
    remove_extra_fields_from_trip_type,
    serialize_trip_type,
)
from customer_api.src.services.trips.airport_transfers_service import remove_extra_fields_from_airport_transfer_trip
from customer_api.src.services.trips.local_hourly_rental_service import (
    remove_extra_fields_from_local_hourly_rental_trip,
)
from customer_api.src.services.trips.outstation_service import remove_extra_fields_from_outstation_trip
from customer_api.src.services.trips.status_service import change_status
from customer_api.src.services.validation_service import validate_serviceable_area, validate_trip_type
from customer_api.src.utils.utility import remove_none_recursive, validate_date_time
...
def serialize_trip(
    ...
    if driver:  # Serialize the driver if it exists
        from customer_api.src.services.driver_service import serialize_driver
    ...
    if options.expose_trip_review:
        from customer_api.src.services.trip_review_service import serialize_rating
