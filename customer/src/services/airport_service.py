...
from customer_api.src.models.airport.airport_orm import AirportModel
from customer_api.src.models.airport.airport_schema import AirportSchema, AirportUpdateSchema
