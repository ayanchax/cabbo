...
from customer_api.src.core.exceptions import FUEL_TYPE_ID_REQUIRED, GENERIC_EXCEPTION, CabboException
from customer_api.src.core.security import RoleEnum
from customer_api.src.models.cab.cab_orm import FuelType
