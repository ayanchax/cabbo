...
from customer_api.src.models.policies.refund_schema import CustomerRefundSchema, RefundSchema

from customer_api.src.services.refund_service import fetch_refund_detail_by_booking_id_and_customer_id
...
@router.get("/refund/{booking_id}", response_model=CustomerRefundSchema)
async def get_refund_details(
    ...
    return CustomerRefundSchema(**refund_details.model_dump(exclude_unset=True, exclude_none=True))
