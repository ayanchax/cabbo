...
from customer_api.src.models.customer.passenger_schema import (
    PassengerCreate,
    PassengerOut,
    PassengerUpdate,
)
...
def list_passengers(
    ...
    if customer is None:
        raise CabboException("Customer not found", status_code=404, error_code=USER_NOT_FOUND)
    from customer_api.src.services.passenger_service import get_all_passengers_by_customer_id
