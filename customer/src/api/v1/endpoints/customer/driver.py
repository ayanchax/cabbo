...
from customer_api.src.services.driver_service import a_get_driver_by_id, get_average_rating_by_driver_id

from customer_api.src.core.security import validate_customer_token
from customer_api.src.core.exceptions import DRIVER_NOT_FOUND, CabboException
