...
from customer_api.src.services.customer_email_verification_service import (
...
from customer_api.src.core.exceptions import EMAIL_ALREADY_VERIFIED, EMAIL_VERIFICATION_CREATION_FAILED, EMAIL_VERIFICATION_FAILED, INVALID_VERIFICATION_LINK, NO_EMAIL_FOUND, CabboException
