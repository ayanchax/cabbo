...
from customer_api.src.core.exceptions import UNAUTHORIZED, CabboException, GENERIC_EXCEPTION, TRIP_TYPE_NOT_SUPPORTED
from customer_api.src.core.security import RoleEnum, validate_user_token
from customer_api.src.models.trip.trip_schema import TripTypeSchema, TripTypeUpdateSchema
