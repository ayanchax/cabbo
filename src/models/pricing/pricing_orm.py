...
class CommonPricingConfiguration(Base):
    ...
    min_outbound_distance_km = Column(Float, nullable=True)  # For airport trips and outstation trips minimum outbound(excluding return and hops) distance threshold for fare calculation, e.g., 2 km for airport trips and 150 km for outstation trips
