...
#         for_customer=True,
#         app_logo_url="https://cdn.example.com/assets/logo.png",
#         app_name="Cabbo",
#         app_url="https://app.cabbo.example",
#         customer_name="Ayan Chacko",
#         booking_id="HR-20260125-AT-0001",
#         pickup_location="Bengaluru Airport (BLR) — Arrival Hall",
#         # airport transfer; no multi-hop required
#         start_date="2026-01-25 10:30 AM",
#         expected_end_date="2026-01-25 02:30 PM",
#         trip_time="10:30 AM",
#         package_label="4 Hours / 40KM - Airport Transfer",
#         included_hours=4,
#         included_km=40,
#         options={"car_type": "Sedan", "fuel_type": "Petrol"},
#         cab_type="Toyota Etios",
#         cab_number="KA02CD5678",
...
#             "minimum_toll_wallet": 0,
#             "minimum_parking_wallet": 200,
#             "permit_fee": 0,
#             "platform_fee": 50,
#         },
#         overages={
...
#             "extra_charges_disclaimers": "Extra hours or kilometres beyond the package will be charged as per standard overage rates.",
#         },
#         in_car_amenities={
#             "ac": True,
#             "music_system": True,
...
#             "wifi": False,
#         },
#         inclusions=["Fuel", "Driver allowance", "Water bottles"],
#         exclusions=["Extra tolls", "Driver meals if trip extended"],
#         total_fare=2250,
#         amount_paid=500,
#         amount_due=1750,
#     )
