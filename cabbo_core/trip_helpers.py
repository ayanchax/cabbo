...
from cabbo_core.exceptions import INVALID_TRIP_TYPE, TRIP_TYPE_ID_NOT_FOUND, CabboException
from cabbo_core.security import RoleEnum, generate_hash
from cabbo_core.trip_constants import OUTSTATION_DEFAULTS, TRIP_RESPONSE_OPTIONS
...
from cabbo_core.models.pricing.pricing_schema import TripPackageConfigSchema
from cabbo_core.models.trip.trip_enums import TripResponseView, TripTypeEnum
from cabbo_core.models.trip.trip_orm import Trip, TripPackageConfig, TripTypeMaster
from cabbo_core.models.trip.trip_schema import  TripDetails, TripSearchOption, TripSearchRequest, TripTypeSchema
from sqlalchemy.orm import Session
from sqlalchemy.ext.asyncio import AsyncSession

from cabbo_core.services.passenger_service import get_passenger_id_from_preferences
import logging
...
def get_prior_booking_window_hours(
    ...
    try:
        from cabbo_core.core.config import settings
