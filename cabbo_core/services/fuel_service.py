...
from cabbo_core.exceptions import FUEL_TYPE_ID_REQUIRED, GENERIC_EXCEPTION, CabboException
from cabbo_core.security import RoleEnum
from cabbo_core.models.cab.cab_orm import FuelType
from cabbo_core.models.cab.cab_schema import FuelTypeSchema
