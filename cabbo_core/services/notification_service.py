...
from cabbo_core.models.customer.customer_schema import CustomerRead
from cabbo_core.models.driver.driver_orm import Driver
from cabbo_core.models.trip.trip_enums import TripTypeEnum
from cabbo_core.models.trip.trip_orm import Trip
from customer.src.core.config import settings

from cabbo_core.services.message_service import (
...
from customer.src.services.trips.airport_transfers_service import get_kwargs_for_airport_transfer
from customer.src.services.trips.local_hourly_rental_service import (
    get_kwargs_for_local_hourly_rental,
)
from customer.src.services.trips.outstation_service import get_kwargs_for_outstation_trip
import logging
