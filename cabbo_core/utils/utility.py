...
from cabbo_core.exceptions import DATETIME_PROCESSING_ERROR, INVALID_DATETIME_INPUT, CabboException
from datetime import date, datetime, timezone, timedelta
from zoneinfo import ZoneInfo
from dateutil.parser import isoparse
from cabbo_core.constants import CABBO_DEFAULT_TIMEZONE
import requests
import re
import logging
...
def validate_date_time(date_time: Union[str, datetime], timezone_str: str = None, utc_offset: int = None) -> Optional[datetime]:
    """
    Parse input (str or datetime). If naive, assume CABBO_DEFAULT_TIMEZONE
    ...
    try:
        ...
        if dt.tzinfo is None:
            if utc_offset is not None:
                ...
                tz_name = timezone_str or CABBO_DEFAULT_TIMEZONE or "UTC"
                try:
