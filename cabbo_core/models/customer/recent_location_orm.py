...
from cabbo_core.constants import CABBO_DEFAULT_LOCATION_SERVICE_PROVIDER
...
class CustomerRecentLocation(Base):
    ...
    provider = Column(String(50), default=CABBO_DEFAULT_LOCATION_SERVICE_PROVIDER, nullable=False)
