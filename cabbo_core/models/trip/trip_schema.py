...
from cabbo_core.exceptions import INVALID_TRIP_TYPE, CabboException
from cabbo_core.models.cab.cab_schema import VehicleCapacitySchema
from cabbo_core.models.common import AmenitiesSchema
from cabbo_core.models.customer.customer_schema import CustomerBase, CustomerRead
from cabbo_core.models.driver.driver_schema import CustomerSafeDriverReadSchema, DriverReadSchema
from cabbo_core.models.policies.cancelation_schema import CancelationPolicySchema, CancelationSchema
from cabbo_core.models.policies.dispute_schema import InitialDisputeSchema
from cabbo_core.models.pricing.pricing_schema import (
...
from cabbo_core.models.customer.passenger_schema import PassengerRequest
from cabbo_core.models.financial.payments_schema import RazorPayPaymentResponse
...
from cabbo_core.models.map.location_schema import LocationInfo
from cabbo_core.constants import CABBO_DEFAULT_TIMEZONE, CABBO_DEFAULT_UTC_OFFSET
...
class TripDetails(BaseModel):
    ...
    timezone: Optional[str] = Field(
        CABBO_DEFAULT_TIMEZONE, description="Timezone of the trip based on the origin location, e.g., 'Asia/Kolkata'"
    )
    utc_offset: Optional[int] = Field(
        CABBO_DEFAULT_UTC_OFFSET, description="UTC offset in minutes for the trip origin timezone, e.g., 330 for IST (UTC+5:30)"
    )
...
class TripSearchRequest(BaseModel):
    ...
    utc_offset: Optional[float] = Field(
        CABBO_DEFAULT_UTC_OFFSET, description="UTC offset of the trip based on the origin location, e.g., 5.5 for IST"
    )
