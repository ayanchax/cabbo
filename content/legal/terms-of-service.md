...
When you place a booking, you must provide correct pickup, drop, trip type, date, time, passenger, and contact details.

Cabbo is focused on scheduled rides, not instant street-hailing. Driver assignment may happen closer to the pickup time. Cabbo may contact you by phone, WhatsApp, SMS, email, push notification, or in-app message for booking updates.

Cabbo may decline, cancel, or modify a booking where required due to driver availability, safety concerns, incorrect details, suspected misuse, payment issues, operational constraints, or events outside Cabbo's reasonable control.

## Customer Responsibilities

You are responsible for:

- Being available at the pickup location on time.
- Keeping your phone reachable before and during the ride.
- Sharing accurate trip details.
- Treating drivers, Cabbo staff, and other passengers respectfully.
- Paying all applicable charges.
- Following lawful and safe conduct during the ride.

You must not carry illegal, unsafe, hazardous, or restricted items in the vehicle.
...
Online payments may be processed through third-party payment partners such as Razorpay or other supported providers. Payment partner terms may also apply.
...
Estimated fares may include base fare, distance/time charges, platform fee, taxes, and other known charges. Some charges, such as tolls, parking, permits, night charges, waiting, route changes, extra kilometers, extra hours, or add-ons, may be added later depending on the ride.

See Cabbo's Fare & Charges Policy for more detail.

## Service Limitations

Cabbo tries to provide reliable booking and support, but availability may depend on location, time, demand, driver availability, traffic, weather, vehicle breakdowns, regulatory restrictions, payment partner issues, network issues, and other operational factors.

Cabbo may update, pause, restrict, or discontinue parts of the service when needed.

To the extent permitted by law, Cabbo is not responsible for indirect, incidental, special, or consequential losses arising from use of the service, delays, cancellations, third-party payment issues, or events outside Cabbo's reasonable control. This does not limit any responsibility that cannot legally be excluded.

## User Content And Communication

You may send messages, support details, reviews, documents, images, or other information to Cabbo. You must ensure that anything you submit is accurate, lawful, and does not violate another person's rights.
